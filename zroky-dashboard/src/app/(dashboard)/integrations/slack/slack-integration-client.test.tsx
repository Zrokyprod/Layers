...
import SlackIntegrationPage from "./slack-integration-client";
...
function alert(overrides: Partial<import("@/lib/types").AlertItemResponse> = {}): import("@/lib/types").AlertItemResponse {
  return {
    alert_id: "alert_1",
    diagnosis_id: "diag_1",
    ...
    evidence: {},
    slack_delivery_status: "sent",
    slack_delivery_attempted_at: "2026-06-24T09:06:00.000Z",
...
describe("SlackIntegrationPage", () => {
  ...
  it("sends a test message and surfaces Slack notification failures", async () => {
    ...
    api.listAlerts.mockResolvedValue({
      ...
      items: [
        ...
        alert({
          ...
          slack_delivery_status: "not_connected",
          slack_delivery_error: "Slack is not connected for this project.",
          slack_delivery_attempted_at: "2026-06-24T09:20:00.000Z",
        }),
      ],
    });
    ...
    expect(screen.getByText("1 alert needs retry")).toBeInTheDocument();
    expect(screen.getByText("Some alerts were not sent. Open Alerts to retry from the alert detail drawer.")).toBeInTheDocument();
