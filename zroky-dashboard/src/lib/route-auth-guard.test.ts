...
describe("guardDashboardRoute", () => {
  ...
  it("still protects active dashboard routes", () => {
    ...
    const evidence = guardDashboardRoute(request("https://app.zroky.com/evidence"));
    ...
    expect(evidence.headers.get("location")).toBe("https://app.zroky.com/login?next=%2Fevidence");
