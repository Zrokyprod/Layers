...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("is_regex", sa.Boolean(), server_default=sa.text("0"), nullable=False),
        ...
        sa.Column("protected", sa.Boolean(), server_default=sa.text("1"), nullable=False),
    ...
    _enable_project_rls("mcp_tool_bindings")
    ...
    op.create_table(
        ...
        sa.Column("protected", sa.Boolean(), server_default=sa.text("0"), nullable=False),
        ...
        sa.Column("forward_attempted", sa.Boolean(), server_default=sa.text("0"), nullable=False),
        sa.Column("forward_succeeded", sa.Boolean(), server_default=sa.text("0"), nullable=False),
    ...
    _enable_project_rls("mcp_interception_events")


def downgrade() -> None:
    _disable_project_rls("mcp_interception_events")
    ...
    _disable_project_rls("mcp_tool_bindings")
