...
from app.services import judge_calibration, judge_engine
...
def make_live_llm_resolver(
    *,
    ...
    def _resolve(trace: GoldenTrace, source_call: Optional[Call]) -> ActualOutput:
        if source_call is None:
            return ActualOutput(text=None, reason="source_call_missing")
        ...
        if isinstance(raw_messages, list):
            ...
            if not prompt_text:
                return ActualOutput(text=None, reason="source_call_missing_prompt")
